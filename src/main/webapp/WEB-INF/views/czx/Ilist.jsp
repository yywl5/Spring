...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/static/czx/css/pagination.css" />
		<style>
		...
		<div class="container" style="min-height:660px;">		
			...
			<div>
				<div class="col-md-3-1">
					<div class="ad">
						<img src="${pageContext.request.contextPath}/static/czx/img/timg.jpg" width="250px" height="165px"/>
						<div style="background-color:white;">&nbsp;</div>
						<img src="${pageContext.request.contextPath}/static/czx/img/timg2.jpg"  width="250px" height="165px"/>
					</div>
				</div>
				...
				<div class="message">
						<img src="${pageContext.request.contextPath}/static/czx/img/z3.png" />
