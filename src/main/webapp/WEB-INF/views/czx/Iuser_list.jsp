...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar">
            <li class="click"><a href="${pageContext.request.contextPath}/toAddUser.action"><span><img src="${pageContext.request.contextPath}/static/czx/img/t01.png" /></span>添加用户</a></li>
        </ul>
    </div>
