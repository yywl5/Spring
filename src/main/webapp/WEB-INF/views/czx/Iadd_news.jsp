...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">首页</a></li>
    <li><a href="${pageContext.request.contextPath}/findNewsByPage.action">文章列表</a></li>
    </ul>
    </div>    
    <div class="formbody">    
    <div class="formtitle"><span>发布文章</span></div>
	   <form action="${pageContext.request.contextPath}/addNews.action" name="ff" method="post" onsubmit="return checkValue()"> 
	   <ul class="forminfo">
    <li><label style="width:150px;">文章标题（<font style="color:Red;font-weight:bolder;">*</font>）：</label><input id="title" name="title" value="${news.title}" type="text" class="dfinput" /><i></i></li>
     <li><label style="width:150px;">文章类别（<font style="color:Red;font-weight:bolder;">*</font>）：</label>
	...
	<i></i></li>
    <li><label style="width:150px;">文章内容页标题（<font style="color:Red;font-weight:bolder;">*</font>）：</label><input id="contentTitle" name="contentTitle" value="${news.contentTitle}" type="text" class="dfinput" /><i></i></li>
