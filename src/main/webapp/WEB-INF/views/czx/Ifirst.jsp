	...
	<body>
		<div class="container">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
				    <div class="item active">
				      <img src="${pageContext.request.contextPath}/static/yywl5/img/background2.png" alt="...">
				      <div class="carousel-caption">
						  爱一本书,恋一座城!
				      </div>
				    </div>
				    <div class="item">
				      <img src="${pageContext.request.contextPath}/static/yywl5/img/background5.jpg" alt="...">
				      <div class="carousel-caption">
						  人到才行,书到无效。
				      </div>
				    </div>
				    <div class="item">
				      <img src="${pageContext.request.contextPath}/static/yywl5/img/background6.jpg" alt="...">
				      <div class="carousel-caption">
						  读万卷书,行万里路。
				      </div>
				    </div>
			...
			<div style="margin-bottom: 20px;padding:0">			
				...
				<div class="inform">						
						<font style="font-size:20px;font-weight:bolder;">读书笔记</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div style="padding-left: 24px;padding-right: 15px;">
						...
						<div class="platformMessage" class="col-md-2 col-sm-4 col-xs-12">
							<img width="40px" src="${pageContext.request.contextPath}/static/czx/img/z3.png"/><!--一个方框的图标-->
				...
				<div class="col-md-4" style="padding-left: 0px;">
					...
					<div class="inform">						
						<font style="font-size:20px;font-weight:bolder;">图书推荐</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div class="informMessage" style="padding-left:24px;">
						...
						<div>
							<img width="40px" src="${pageContext.request.contextPath}/static/czx/img/z3.png"  />
