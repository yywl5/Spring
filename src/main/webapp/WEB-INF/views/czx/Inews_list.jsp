...
<body>
    ...
    <div class="tools">    
    	<ul class="toolbar">
        <li class="click"><a href="${pageContext.request.contextPath}/toAddNews.action"><span><img src="images/t01.png" /></span>发布文章
		</a></li>
        </ul>
       </div>
       <form action="${pageContext.request.contextPath}/findNewsByPage.action" id="newsListForm"
	    	...
	    	<thead>
	    	<tr>
	        <th style="width:100px;text-align:center;">文章
				标题</th>
	        <th style="width:100px;text-align:center;">文章
				类别</th>
