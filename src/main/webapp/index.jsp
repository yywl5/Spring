...
<head>
    ...
    <title>图书管理系统</title>
    <link rel="stylesheet" href="./static/yywl5/css/index.css">
...
<header>
        ...
        <section id="timeline">
            <div class="timeline">
                ...
                <article>
                    ...
                    <figure>
                        <figcaption>社会科学和自然科学</figcaption>
                        <h6>science</h6>
                        <p>自然科学（natural science）是一门以观察和实验的经验证据为基础，对自然现象进行描述、理解和预测的科学分支。同行评审和研究结果的可重复性等机制被用来确保科学进步的有效性。</p>
                    </figure>

                    <figure>
                        <figcaption>哲学、宗教</figcaption>
                        <h6>Philosophy</h6>
                        <p>世界观是关于世界的本质、发展的根本规律、人的思维与存在的根本关系等普遍基本问题的总体认识，方法论是关于人们认识世界、改造世界的方法的理论。</p>
                    </figure>

                    <figure>
                        <figcaption>政治、法律</figcaption>
                        <h6>law</h6>
                        <p>政治（Politics）是指政府、政党等治理国家的行为。政治是以经济为基础的上层建筑，是经济的集中表现，是以国家权力为核心展开的各种社会活动和社会关系的总和。政治是牵动社会全体成员的利益并支配其行为的社会力量。</p>
                    </figure>
                ...
                <article>
                    <h2>图书管理</h2>
                    <figure>
                        <figcaption>自然科学总论</figcaption>
                        <h6>science</h6>
                        <p>以人类认识自然、改造自然的史实为基础,以历史进程为线索,力求以不同社会发展阶段的自然科学成就和著名科学家具有划时代意义的发现、发明及学说为主要内容,概括地分析和阐明自然科学及其学科地对象、特点、发展规律与历史作用,粗略地介绍自然科学地知识体系</p>
                    </figure>

                    <figure>
                        <figcaption>农业科学</figcaption>
                        <h6>agricultre</h6>
                        <p>农业科学是研究农业发展的自然规律和经济规律的科学，因涉及农业环境、作物和畜牧生产、农业工程和农业经济等多种科学而具有综合性。林业科学和水产科学有时也包括在广义的农业科学范畴之内。</p>
                    </figure>

                    <figure>
                        <figcaption>工业技术</figcaption>
                        <h6>Industry</h6>
                        <p>工业是对自然资源的开采、采集和对各种原材料进行加工的社会物质生产部门。工业(industry)是加工制造产业，工业是社会分工发展的产物，经过手工业、机器工业几个发展阶段。工业是第二产业的主要组成部分，分为轻工业和重工业两类。</p>
                    </figure>
    ...
    <div class="a1 l" >
        <div class="Fragram1">
            <section class="section1">
                <div class="book">
                    <img src="./static/yywl5/img/BookHead.jpg" alt="">
                </div>
            </section>
            <section class="section2">
                <h3 class="text" id="text">A new adult romance from Entangled's Embrace imprint...<br>
                    ...
                    Not since my best friend died and I screwed up the one promise he asked me to make.
                </h3>
            </section>
        </div>
    </div>
    <div class="a1" style="background-color:transparent">
        <img src="./static/yywl5/img/wallpaper.jpg" alt="" style="border-radius: 0"/>
        <div id="container5p">
            <h2>共享美好时光!</h2>
            <p class="container5_text">
                <br />
                如果有天堂,天堂应该是图书馆的模样。”我想在这喧嚣的城市,如果能经常在某个上午或者下午,独自一人走进图书馆,静静地消磨那美好的翻动书页的幸福时光。
            </p>
            <input type="text" value="点击查看详情" /><a href="">了解更多</a>
            <div class="coffeeDiscount"></div>
        </div>
        <div class="container5">
            <div class="plate5"></div>
            <div class="cup5">
                <div class="top5">
                    <div class="vapour5">
                        <span style="--i: 5"></span>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="content">
                    <h2>自动化借书</h2>
                    <p>
                        为方便读者和简化借书操作，人文社科图书馆向读者提供自助借书服务。读者不必通过图书馆员即可自己进行借书操作。
                    </p>
                    <a href="#">Read More</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    <h2>图书归还</h2>
                    <p>
                        通过读者的E-mail联络方式，将读者逾期未归还的书刊目录以电子邮件的方式发送给读者，提醒读者按期归还图书。即：距离读者所借图书还书日期还有7天就以E-mail的方式提醒读者；在读者所借图书过期后将每隔7天再以E-mail的方式继续提醒。
                    </p>
                    <a href="#">Read More</a>
                </div>
            </div>
    ...
    <div class="a1 l" style="background-color:#bbded6">
        <img src="./static/yywl5/img/background2.png" style="box-shadow: none;width: 100%;height: auto;border-radius: 0;" alt="">
    </div>
</header>
    <div id="navigator">
        <!--navigation section-->
    ...
    <div id="mainCont1">
        ...
        <button style="margin-top: 70px;" onclick="bigWhiteFinal('./login.jsp')">进入登录&gt;</button>
        <button style="margin-top: 30px;" onclick="bigWhiteFinal('./forum.jsp')">留言&gt;</button>
        <button style="margin-top: 30px;" onclick="bigWhiteFinal('./book.jsp')">查看图书&gt;</button>
        <button style="margin-top: 30px;" onclick="bigWhiteFinal('./index2.jsp')">星星云&gt;</button>
...
<script src="./static/yywl5/js/time.js"></script>
<script>
    ...
    <script src="./static/yywl5/js/animation.js"></script>
    <script>
        function aboutDis() {
